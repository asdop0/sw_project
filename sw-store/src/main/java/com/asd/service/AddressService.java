...
public class AddressService {
	...
	public void addAddress(Address address, User user) {
		try {
			Optional<Address> preAddress = addressRepository.findByUserAndChoice(user, "true");
	...
	public Address getAddress(User user) {
		Address address = addressRepository.findByUserAndChoice(user, "true").orElseThrow(() -> 
